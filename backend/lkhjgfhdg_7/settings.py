"""
Django settings for lkhjgfhdg_7 project.
...
WSGI_APPLICATION = 'lkhjgfhdg_7.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "lkhjgfhdg_7 API",
    "DESCRIPTION": "API documentation for lkhjgfhdg_7 App",
    "VERSION": "v1",
}
